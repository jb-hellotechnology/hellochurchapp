				...
				<article>
					<div class="plan-container sortable">
						...
						foreach($plan as $type => $item){
							...
							if($type=='youtube'){
								echo '<div class="plan-item youtube draggable"><label>YouTube</label><a href=""><span class="material-symbols-outlined">drag_indicator</span></a><input type="text" name="youtube_'.rand().'" placeholder="https://youtu.be/..." value="'.$item.'" /><a href="javascript:;" class="delete-from-plan warning"><span class="material-symbols-outlined">delete</span></a></div>';
							}
							if($type=='bible'){
