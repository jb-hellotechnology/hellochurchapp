<?php
    ...
    if (  function_exists( 'get_magic_quotes_runtime' ) && get_magic_quotes_runtime()) ini_set('magic_quotes_runtime', 0);//set_magic_quotes_runtime(false);
    ...
    include(PERCH_CORE.'/lib/vendor/autoload.php');
