...
class PerchMembers_Members extends PerchAPI_Factory
{
	...
	public $static_fields = array('memberID', 'memberAuthType', 'memberAuthID', 'memberEmail', 'memberPassword', 'memberStatus', 'memberCreated', 'memberExpires', 
    'memberCustomerID', 'memberSubscriptionID', 'memberPaymentMethod', 'memberPeriodEnd', 'memberCancel', 'memberPlanID', 'memberCost', 'memberProperties');
	...
	public function register_with_form($SubmittedForm)
	{
		...
		if (is_object($Form)) {
	    	...
	    	$properties['reference'] = rand(1000000,9999999);
