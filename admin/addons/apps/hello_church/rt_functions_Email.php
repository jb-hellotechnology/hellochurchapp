<?php
    ...
    function hello_church_get_email_content($emailID){
		...
		if($church['churchEmailTheme']=='green'){
			...
			$emailContent = '<style>.email-preview a{color:'.$button.';border-bottom:1px solid '.$button.'}</style>';
		}
								  ...
								  <tr>
									<td align="left" style="font-family: '.$font.'; font-size: 16px; vertical-align: top; padding-bottom: 16px;" valign="top">
									  <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: auto;">
										<tbody>
										  <tr>
											<td style="font-family: '.$font.'; font-size: 16px; vertical-align: top; border-radius: 4px; text-align: center; background-color: '.$button.'" valign="top" align="center" bgcolor="#0867ec"> <a href="'.$item.'" target="_blank" style="border: solid 2px '.$button.' border-radius: 4px; box-sizing: border-box; cursor: pointer; display: inline-block; font-size: 16px; font-weight: bold; margin: 0; padding: 12px 24px; text-decoration: none; text-transform: capitalize; background-color: '.$button.' border-color: '.$button.' color: #ffffff;">'.$buttonText.'</a> </td>
										  </tr>
										</tbody>
									  </table>
									</td>
									  ...
									  <tr>
										<td align="left" style="font-family: '.$font.'; font-size: 16px; vertical-align: top; padding-bottom: 16px;" valign="top">
										  <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: auto;">
											<tbody>
											  <tr>
												<td style="font-family: '.$font.'; font-size: 16px; vertical-align: top; border-radius: 4px; text-align: center; background-color: '.$button.'" valign="top" align="center" bgcolor="#0867ec"> <a href="https://app.churchplanner.co.uk/feed/file/'.$file['churchID'].'/'.$file['fileID'].'" target="_blank" style="border: solid 2px '.$button.' border-radius: 4px; box-sizing: border-box; cursor: pointer; display: inline-block; font-size: 16px; font-weight: bold; margin: 0; padding: 12px 24px; text-decoration: none; text-transform: capitalize; background-color: '.$button.' border-color: '.$button.' color: #ffffff;">Download: '.$file['fileName'].'</a> </td>
											  </tr>
											</tbody>
										  </table>
										</td>
