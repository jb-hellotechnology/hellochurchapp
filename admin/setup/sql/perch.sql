...
CREATE TABLE IF NOT EXISTS `__PREFIX__menu_item_features` (
...
INSERT INTO `__PREFIX__menu_item_features` (`featureID`, `parentID`, `featureType`, `featureOrder`, `featureTitle`, `featureValue`, `featurePersists`, `featureActive`, `privID`, `userID`, `featureInternal`)
VALUES
